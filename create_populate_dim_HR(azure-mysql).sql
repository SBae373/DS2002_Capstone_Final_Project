-- ------------------------------------------
-- here I am creating the dimension tables -- 
-- ------------------------------------------
CREATE DATABASE `HR_management_DW` /*!40100 DEFAULT CHARACTER SET latin1 */ /*!80016 DEFAULT ENCRYPTION='N' */;

USE HR_management_DW;
...
-- -----------------------------------------------------------
-- now I am creating a Fact Table for my dimensions tables -- 
-- -----------------------------------------------------------
USE HR_management_DW;
CREATE TABLE `fact` (
	`fact_key` int NOT NULL AUTO_INCREMENT,
    `employee_key` int DEFAULT NULL,
    `job_key` int DEFAULT NULL,
    `department_key` int DEFAULT NULL,
    `location_key` int DEFAULT NULL,
    `hire_date` date NOT NULL,
	`salary` decimal(8,2) NOT NULL,
